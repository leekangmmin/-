...
| 로컬 AI | 선택 | Ollama/llama.cpp 확장 경로, 점수 미반영 |
| 클라우드 AI | 선택·기본 꺼짐 | 명시적으로 설정한 경우에만 사용, 점수 미반영 |
...
운영 표시 점수는 결정론적 Offline Core가 계산합니다. 선택형 AI 결과는 추가 피드백에만 사용되며 현재 공식 표시 점수를 변경하지 않습니다.
...
- 로컬/클라우드 AI 확장은 현재 운영 표시 점수를 바꾸지 않습니다.
